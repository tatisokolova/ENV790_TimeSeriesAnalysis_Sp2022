...
df_wind_decomposed <- data.frame("Date"=full_wind_data$Date,wind_random,wind_trend,wind_seasonal)
...
The way that decompose is fixing the data and is subtracting end points of the data
