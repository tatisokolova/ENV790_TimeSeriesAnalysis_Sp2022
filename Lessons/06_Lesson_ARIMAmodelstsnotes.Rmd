...
```{r}
ts_electricity_price <- ts(electricity_price_processed[,2:(nvar+1)], #starting at column 2 bc dont want to include date in time series
...
ggplot(df_residential, aes(x=Month)) + #dont need x=month for each line
