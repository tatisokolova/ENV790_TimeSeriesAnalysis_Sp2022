...
output: pdf_document
editor_options: 
<<<<<<< HEAD:Lessons/03_Lesson_ImportData_ACF_PACF_TSv0.Rmd
  chunk_output_type: inline
=======
  chunk_output_type: console
>>>>>>> 096f2e2b7bd34a4e0634b0adefe193f4e2d827eb:Lessons/03_Lesson_ImportData_ACF_PACF.Rmd
---
...
#sharing with other people becomes more difficult
raw_inflow_data <- read.table(file="/Users/Tatiana/OneDrive - Duke University/ENV 790 Time Series/ENV790_TimeSeriesAnalysis_Sp2022/Data/inflowtimeseries.txt",header=FALSE,skip=0)

#Option 2: import using shortcut "." or ".." or relative path aka BEST PATHclass
# the "." will point to the folder set as the current directory
# the ".." will point to your parent folder set as the current directory
...
```{r}
#using package ggplot2, aes stands for aesthetic
...
#ts.plot also plots time series data
```
